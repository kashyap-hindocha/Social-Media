  ...
  return (
    <div className="m-2 ">
      <div 
        ...
        >
      <img className="rounded-lg w-full" src={urlFor(image).width(1000).url()} alt="user-post" />
      {postHovered && (
        <div 
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2">
              <a 
                ...
                className="bg-white w-9 h-9 rounded-full flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md ourline-none"
                >
                  <MdDownload />
                </a>
            </div>
           ...
           <div className="flex justify-between items-venter gap-2 w-full">
                {destination && (
                  <a 
                    href={destination}
                    target="_blank"
